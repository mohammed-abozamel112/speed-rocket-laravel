                    ...
                    <ul class="flex justify-center gap-6 mt-8 md:gap-8">
                        <li>
                            <a href="/" rel="noopener noreferrer" target="_blank"
                                class="text-[#A31621] transition hover:text-[#a31622ad]">
                                <span class="sr-only">Facebook</span>
                                <svg class="w-10 h-10" fill="#A31621" viewBox="0 0 24 24" aria-hidden="true">
                        ...
                        <li>
                            <a href="/" rel="noopener noreferrer" target="_blank"
                                class="text-[#A31621] transition hover:text-[#A31621]/75">
                        ...
                        <ul class="mt-8 space-y-4 text-sm">
                            <li>
                                <a class="flex items-center justify-center sm:justify-start gap-1.5 group"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-[#A31621] shrink-0"
                                        fill="none" viewBox="0 0 24 24" stroke="#A31621" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                            d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                    </svg>

                                    <span class="text-[#A31621] transition group-hover:text-[#A31621]/75">
                                        info@fid.sa
                                    </span>
                                </a>
                            </li>
                            ...
                            <li class="flex items-start justify-center gap-1.5 sm:justify-start">
                                ...
                                <address class="-mt-0.5 not-italic text-[#A31621]">
            ...
            <div class="pt-6 mt-12 border-t border-gray-800">
                <div class="text-center sm:flex sm:justify-between sm:text-left">
                    <p class="text-sm text-gray-400">
                        ...
                        <a class="inline-block text-[#A31621] underline transition hover:text-[#A31621]/75"
                            href="/">
