        ...
        <div class="max-w-4xl mx-auto">
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="flex space-x-2 {{ $isRtl ? 'space-x-reverse' : '' }}">
                    <a href="{{ route('clients.edit', ['lang' => app()->getLocale(), 'client' => $client]) }}" class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded">
                        {{ $isRtl ? 'تعديل' : 'Edit' }}
                    </a>
                    <a href="{{ route('clients.index', ['lang' => app()->getLocale()]) }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">
                        {{ $isRtl ? 'رجوع' : 'Back' }}
                    </a>
                </div>
            </div>
            ...
            <div class="bg-white shadow-md rounded-lg p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2 flex justify-center">
                        @if($client->image)
                            <img src="{{ asset('storage/' . $client->image) }}" alt="{{ $isRtl ? $client->name_ar : $client->name_en }}" class="w-48 h-48 object-cover rounded-lg shadow-md">
                        @else
                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            <p class="text-gray-800 {{ $textAlign }} whitespace-pre-wrap">{{ $client->description_en }}</p>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            <p class="text-gray-800 {{ $textAlign }} whitespace-pre-wrap">{{ $client->description_ar }}</p>
                        </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="mb-4">
                                ...
                                <span class="px-3 py-1 text-xs font-semibold rounded-full {{ $client->status ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                            ...
                            <div class="mb-4">
                                ...
                                <p class="text-gray-800 {{ $textAlign }}">{{ $client->created_at->format('Y-m-d H:i') }}</p>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <p class="text-gray-800 {{ $textAlign }}">{{ $client->updated_at->format('Y-m-d H:i') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
