<x-master-layout>
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-4xl mx-auto">
            ...
            <form action="{{ route('clients.update', ['lang' => app()->getLocale(), 'client' => $client]) }}"
                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            <input
                                ...
                                id="name_en" type="text" name="name_en"
                                value="{{ old('name_en', $client->name_en) }}" required>
                            @error('name_en')
                        ...
                        <div class="mb-4">
                            ...
                            <textarea
                                ...
                                id="description_en" name="description_en" rows="3">{{ old('description_en', $client->description_en) }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <input
                                ...
                                id="category_en" type="text" name="category_en"
                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            <input
                                ...
                                id="name_ar" type="text" name="name_ar"
                                value="{{ old('name_ar', $client->name_ar) }}" required>
                            @error('name_ar')
                                <p class="text-red-500 text-xs italic {{ $textAlign }}">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea
                                ...
                                id="description_ar" name="description_ar" rows="3">{{ old('description_ar', $client->description_ar) }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <input
                                ...
                                id="category_ar" type="text" name="category_ar"
                    ...
                    <div class="mb-4">
                        ...
                        <select
                            ...
                            <option value="1" {{ old('status', $client->status) == 1 ? 'selected' : '' }}>
                                {{ $isRtl ? 'نشط' : 'Active' }}</option>
                            <option value="0" {{ old('status', $client->status) == 0 ? 'selected' : '' }}>
                                {{ $isRtl ? 'غير نشط' : 'Inactive' }}</option>
                        </select>
                        @error('status')
                            <p class="text-red-500 text-xs italic {{ $textAlign }}">{{ $message }}</p>
                        @enderror
