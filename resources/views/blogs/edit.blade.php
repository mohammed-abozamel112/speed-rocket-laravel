...
<div class="container mx-auto px-4">
    ...
    <form action="{{ route('blogs.update', ['lang' => app()->getLocale(), 'blog' => $blog]) }}" method="POST" enctype="multipart/form-data" class="max-w-4xl">
        ...
        <div class="mb-4">
            <label for="title_{{ $lang }}" class="block text-gray-700 font-bold mb-2">Title ({{ strtoupper($lang) }})</label>
            <input type="text" name="title_{{ $lang }}" id="title_{{ $lang }}" value="{{ old('title_'.$lang, $blog->{'title_'.$lang}) }}" required
                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
        </div>

        <div class="mb-4">
            <label for="short_description_{{ $lang }}" class="block text-gray-700 font-bold mb-2">Short Description ({{ strtoupper($lang) }})</label>
        ...
        <div class="mb-4">
            <label for="sub_title1_{{ $lang }}" class="block text-gray-700 font-bold mb-2">Sub Title 1 ({{ strtoupper($lang) }})</label>
            <input type="text" name="sub_title1_{{ $lang }}" id="sub_title1_{{ $lang }}" value="{{ old('sub_title1_'.$lang, $blog->{'sub_title1_'.$lang}) }}"
                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
        </div>

        <div class="mb-4">
            <label for="sub_title2_{{ $lang }}" class="block text-gray-700 font-bold mb-2">Sub Title 2 ({{ strtoupper($lang) }})</label>
            <input type="text" name="sub_title2_{{ $lang }}" id="sub_title2_{{ $lang }}" value="{{ old('sub_title2_'.$lang, $blog->{'sub_title2_'.$lang}) }}"
                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
        </div>

        <div class="mb-4">
            <label for="sub_title3_{{ $lang }}" class="block text-gray-700 font-bold mb-2">Sub Title 3 ({{ strtoupper($lang) }})</label>
            <input type="text" name="sub_title3_{{ $lang }}" id="sub_title3_{{ $lang }}" value="{{ old('sub_title3_'.$lang, $blog->{'sub_title3_'.$lang}) }}"
                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
        </div>

        <div class="mb-4">
            <label for="description1_{{ $lang }}" class="block text-gray-700 font-bold mb-2">Description 1 ({{ strtoupper($lang) }})</label>
        ...
        <div class="mb-4">
            <label for="description2_{{ $lang }}" class="block text-gray-700 font-bold mb-2">Description 2 ({{ strtoupper($lang) }})</label>
        ...
        <div class="mb-4">
            <label for="description3_{{ $lang }}" class="block text-gray-700 font-bold mb-2">Description 3 ({{ strtoupper($lang) }})</label>
        ...
        <div class="mb-4">
            ...
            @if($blog->image)
                <div class="mb-2">
                    <img src="{{ asset('storage/' . $blog->image) }}" alt="{{ $blog->title }}" class="max-w-full h-auto rounded">
                </div>
            @endif
