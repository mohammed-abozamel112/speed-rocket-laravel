<x-master-layout>
    ...
    <section class="w-full min-h-screen relative py-32 overflow-hidden">
        ...
        <div class="absolute inset-0 overflow-hidden opacity-20">
            <div class="absolute top-1/4 left-1/4 w-2 h-2 bg-[#f59c00] rounded-full animate-float"></div>
            <div class="absolute top-1/3 right-1/5 w-3 h-3 bg-[#f59c00] rounded-full animate-float-2"></div>
            <div class="absolute bottom-1/4 left-1/5 w-1 h-1 bg-[#f59c00] rounded-full animate-float-3"></div>
            <div class="absolute bottom-1/3 right-1/4 w-2 h-2 bg-[#f59c00] rounded-full animate-float-4"></div>
        </div>
        ...
        <div
            ...
            <div
                class="inline-flex items-center rounded-full border border-[#f59c00] bg-[#fcf7f9] px-6 py-3 text-sm font-medium text-[#f59c00] mb-8">
                {{ $isRtl ? '🚀 نقود الابتكار منذ 2020' : '🚀 Powering Innovation Since 2020' }}
            </div>

            <!-- Headline with glow effect -->
            <h1 class="text-5xl sm:text-7xl font-extrabold text-[#f59c00] mb-8 leading-tight">
                {{ $isRtl ? 'نبني' : 'Building the' }}
                <span
                    class="bg-gradient-to-r from-[#f59c00] to-[#fcf7f9] bg-clip-text text-transparent animate-text-glow">
                    {{ $isRtl ? 'المستقبل' : 'Future' }}
                </span>
                <br>{{ $isRtl ? 'بسرعة الضوء' : 'at Light Speed' }}
            </h1>

            <p class="text-2xl text-gray-400 max-w-4xl mx-auto leading-relaxed mb-12">
                {{ $isRtl
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-8 max-w-4xl mx-auto">
                <div class="text-center group animate-fade-in-up" style="animation-delay: 100ms">
                    <div
                        class="w-16 h-16 mx-auto mb-4 bg-gradient-to-r from-[#f59c00] to-[#f59c00] rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-[#f59c00] hover:shadow-[#f59c00]">
                    ...
                    <div class="text-3xl font-bold text-[#f59c00] mb-2 group-hover:text-[#f59c00] transition-colors">
                        500+
                    </div>
                    <div class="text-gray-400 text-sm font-medium group-hover:text-gray-100 transition-colors">
                ...
                <div class="text-center group animate-fade-in-up" style="animation-delay: 200ms">
                    ...
                    <div class="text-3xl font-bold text-[#f59c00] mb-2 group-hover:text-[#f59c00] transition-colors">98%
                    </div>
                    <div class="text-gray-400 text-sm font-medium group-hover:text-gray-100 transition-colors">
                ...
                <div class="text-center group animate-fade-in-up" style="animation-delay: 300ms">
                    <div
                        class="w-16 h-16 mx-auto mb-4 bg-gradient-to-r from-[#f59c00] to-[#f59c00] rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-[#f59c00]/25 hover:shadow-[#f59c00]/40">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" class="h-8 w-8 text-white">
                    ...
                    <div class="text-3xl font-bold text-[#f59c00] mb-2 group-hover:text-[#f59c00] transition-colors">3x
                    </div>
                    <div class="text-gray-400 text-sm font-medium group-hover:text-gray-100 transition-colors">
    ...
    <section class="w-full py-32 bg-gray-850 relative overflow-hidden">
        ...
        <div class="absolute bottom-0 right-0 w-64 h-64 bg-[#f59c00] rounded-full filter blur-3xl opacity-10 animate-pulse-slow"
            style="animation-delay: 2s"></div>

        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-20 animate-fade-in">
                <h2 class="text-4xl sm:text-5xl font-bold text-[#f59c00] mb-6">
                    {{ $isRtl ? 'الحمض النووي' : 'Our ' }} <span
                        class="bg-gradient-to-r from-[#f59c00] to-[#c9c5c5] bg-clip-text text-transparent animate-text-glow">{{ $isRtl ? '' : 'DNA' }}</span>
                    {{ $isRtl ? '' : '' }}
                </h2>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                <div
                    class="rounded-lg border border-[#f59c00] bg-gradient-to-br from-[#f59c00] to-[#fcf7f9] p-6 shadow-sm transition-all duration-500 group relative overflow-hidden hover:border-[#f59c00] hover:-translate-y-2">
                    <div
                    ...
                    <div class="relative z-10 pb-8">
                        <div
                            class="w-20 h-20 bg-gradient-to-r from-[#f59c00] to-[#f59c00] rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-[#f59c00]/25">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="h-10 w-10 text-white">
                                <path d="M4.5
                                16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.97-2.07 1.67-2.92C11.26 10.3 15.5 10 15.5
                                10l-1.67-1.67c-.85-.7-2.08-.96-2.92-1.67-1.26-1.5-2-5-2-5s3.74-.5 5-2c.84.71 2.07.97
                                2.92 1.67C13.7 8.74 14 13 14 13l1.67 1.67c.7-.85.96-2.08 1.67-2.92 1.5-1.26 5-2 5-2s-.5
                                3.74-2 5c-.71.84-.97 2.07-1.67 2.92C10.3 11.26 10 15.5 10 15.5l-1.67
                                1.67c-.85.7-2.08.96-2.92 1.67Z">
                                </path>
                                <path d="M19 14V6l-2.5-2.5L12 2"></path>
                                <path d="M15 11l-2.5-2.5L10 6"></path>
                                <path d="M19 14l-2.5-2.5L10 6"></path>
                        ...
                        <h3 class="text-3xl font-bold text-white mb-4 group-hover:text-[#f59c00] transition-colors">
                            {{ $isRtl ? 'مهمتنا' : 'Our Mission' }}</h3>
                    </div>
                    <div class="relative z-10">
                        <p
                            class="text-gray-100 text-lg leading-relaxed mb-8 group-hover:text-gray-200 transition-colors">
                            {{ $isRtl
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center space-x-3 group-hover:translate-x-1 transition-transform">
                                <div class="w-2 h-2 bg-[#f59c00] rounded-full animate-pulse"></div>
                                <span
                                    class="text-gray-400 font-medium group-hover:text-gray-100 transition-colors">{{ $isRtl ? 'تطوير MVP سريع' : 'Rapid MVP Development' }}</span>
                            </div>
                            <div class="flex items-center space-x-3 group-hover:translate-x-1 transition-transform"
                                style="transition-delay: 50ms">
                                <div class="w-2 h-2 bg-[#f59c00] rounded-full animate-pulse"
                                    style="animation-delay: 150ms"></div>
                                <span
                                    class="text-gray-400 font-medium group-hover:text-gray-100 transition-colors">{{ $isRtl ? 'جودة بمستوى مؤسسي' : 'Enterprise-Grade Quality' }}</span>
                            </div>
                            <div class="flex items-center space-x-3 group-hover:translate-x-1 transition-transform"
                                ...
                                <span
                                    class="text-gray-400 font-medium group-hover:text-gray-100 transition-colors">{{ $isRtl ? 'ابتكار متاح' : 'Accessible Innovation' }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center space-x-3 group-hover:translate-x-1 transition-transform">
                                <div class="w-2 h-2 bg-[#f59c00] rounded-full animate-pulse"></div>
                                <span
                                    class="text-gray-400 font-medium group-hover:text-gray-100 transition-colors">{{ $isRtl ? 'تأثير عالمي' : 'Global Impact' }}</span>
                            </div>
                            <div class="flex items-center space-x-3 group-hover:translate-x-1 transition-transform"
                                style="transition-delay: 50ms">
                                <div class="w-2 h-2 bg-[#f59c00] rounded-full animate-pulse"
                                    style="animation-delay: 150ms"></div>
                                <span
                                    class="text-gray-400 font-medium group-hover:text-gray-100 transition-colors">{{ $isRtl ? 'ريادة في الصناعة' : 'Industry Leadership' }}</span>
                            </div>
                            <div class="flex items-center space-x-3 group-hover:translate-x-1 transition-transform"
                                style="transition-delay: 100ms">
                                <div class="w-2 h-2 bg-[#f59c00] rounded-full animate-pulse"
                                    style="animation-delay: 300ms"></div>
                                <span
                                    class="text-gray-400 font-medium group-hover:text-gray-100 transition-colors">{{ $isRtl ? 'سرعة ثورية' : 'Revolutionary Speed' }}</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="py-32 relative overflow-hidden">
        ...
        <div
            class="absolute top-0 left-1/4 w-96 h-96 bg-gradient-to-r from-[#f59c00] to-[#f59c00]/10 rounded-full filter blur-3xl opacity-20 animate-float">
        </div>
        <div
            class="absolute bottom-0 right-1/4 w-96 h-96 bg-gradient-to-r from-[#f59c00]/10 to-[#f59c00] rounded-full filter blur-3xl opacity-20 animate-float-2">
        </div>
            ...
            <div class="text-center mb-20 animate-fade-in">
                <h2 class="text-4xl sm:text-5xl font-bold text-[#f59c00] mb-6">
                    {{ $isRtl ? 'ما الذي يدفعنا' : 'What Drives' }} <span
                        class="bg-gradient-to-r from-[#f59c00] to-[#f59c00] bg-clip-text text-transparent animate-text-glow">{{ $isRtl ? '' : 'Us' }}</span>
                </h2>
                <p class="text-xl text-gray-400 max-w-3xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
                <div class="group text-center animate-fade-in-up" style="animation-delay: 100ms">
                    <div class="relative mb-8">
                        <div
                            class="w-32 h-32 mx-auto bg-gradient-to-br from-[#f59c00] to-[#fcf7f9] rounded-3xl flex items-center justify-center group-hover:scale-110 transition-all duration-500 shadow-2xl border border-[#f59c00] group-hover:border-[#f59c00]">
                            <div
                                class="w-20 h-20 bg-gradient-to-r from-[#f59c00] to-[#f59c00] rounded-2xl flex items-center justify-center group-hover:rotate-12 transition-transform duration-500 shadow-lg shadow-[#f59c00]/25">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round" class="h-10 w-10 text-white">
                        ...
                        <!-- Subtle glow effect -->
                        <div
                            class="absolute inset-0 rounded-3xl bg-gradient-to-r from-[#f59c00] to-[#f59c00] opacity-0 group-hover:opacity-10 blur-md transition-opacity duration-500 -z-10">
                        </div>
                    </div>
                    <h3
                        class="text-2xl font-bold text-[#f59c00] mb-6 group-hover:text-[#f59c00] transition-colors duration-300">
                        {{ $isRtl ? 'سريع كالبرق' : 'Lightning Fast' }}
                    </h3>
                    <p
                        class="text-gray-400 text-lg leading-relaxed group-hover:text-gray-100 transition-colors duration-300">
    ...
    <section class="py-32 bg-gradient-to-br from-gray-850 to-gray-900 relative overflow-hidden">
        ...
        <div class="absolute inset-0 overflow-hidden opacity-10">
            <div class="absolute top-1/4 left-1/4 w-1 h-1 bg-[#f59c00] rounded-full animate-float"></div>
            <div class="absolute top-1/3 right-1/5 w-2 h-2 bg-[#f59c00] rounded-full animate-float-2"></div>
            <div class="absolute bottom-1/4 left-1/5 w-1 h-1 bg-[#f59c00] rounded-full animate-float-3"></div>
            <div class="absolute bottom-1/3 right-1/4 w-1 h-1 bg-[#f59c00] rounded-full animate-float-4"></div>
        </div>
            ...
            <div class="text-center mb-20 animate-fade-in">
                <h2 class="text-4xl sm:text-5xl font-bold text-[#f59c00] mb-6">
                    {{ $isRtl ? 'تعرف على الروّاد' : 'Meet the' }} <span
                        class="bg-gradient-to-r from-[#f59c00] to-[#f59c00] bg-clip-text text-transparent animate-text-glow">{{ $isRtl ? '' : 'Visionaries' }}</span>
                </h2>
                <p class="text-xl text-gray-400 max-w-3xl mx-auto">
