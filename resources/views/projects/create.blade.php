<x-master-layout>
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-2xl mx-auto">
            ...
            <form action="{{ route('projects.store', app()->getLocale()) }}" method="POST"
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        id="title_ar" type="text" name="title_ar" value="{{ old('title_ar') }}" required>
                    @error('title_ar')
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        id="title_en" type="text" name="title_en" value="{{ old('title_en') }}" required>
                    @error('title_en')
                        <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        id="category_ar" type="text" name="category_ar" value="{{ old('category_ar') }}">
                    @error('category_ar')
                        <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        id="category_en" type="text" name="category_en" value="{{ old('category_en') }}">
                    @error('category_en')
                        <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        id="external_url" type="url" name="external_url" value="{{ old('external_url') }}">
                    @error('external_url')
                        <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
                </div>
